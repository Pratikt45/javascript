//Comparission Operator Classwork
 ...
 var result = num1 == num2;
  // Implicit conversion in this case the string present in a variable is converted into the number variable only in (==) case ex=> num2 = "100"(string) converted to num2=> 100(number)
